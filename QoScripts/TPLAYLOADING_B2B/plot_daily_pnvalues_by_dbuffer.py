...
#input=sys.argv[2]
#output=sys.argv[3]
input1="./out/total/pnvalues_of_%s_vod_dbuffer" % ver1
...
plt.grid()
plt.title("pnvalues of vod dbuffer of %s" % ver1)

plt.savefig("./png/daily_pn_plot_by_vod_dbuffer_of_%s_%s.png" % (ver1, time))
